...
import org.opencastproject.google.BackOffRequiredImpl;
 ...
 */
public class InHouseGoogleCredential extends GoogleCredential {
  ...
  public InHouseGoogleCredential(final GoogleCredential.Builder builder, final BackOff backOff) {
    super(builder);
